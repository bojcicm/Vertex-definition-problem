...
namespace vxe {
	...
	template <>
	class Cube<DirectX::VertexPositionColorExtended, unsigned short> : public MeshBase<DirectX::VertexPositionColorExtended, unsigned short> {
	...
	public:
		...
		virtual concurrency::task<void> CreateAsync(_In_ ID3D11Device2* device)
		{
			...
			std::vector<DirectX::VertexPositionColorExtended> vertices = {
				DirectX::VertexPositionColorExtended(DirectX::XMFLOAT3(-1.0f, 1.0f, -1.0f), DirectX::XMFLOAT4(0.0f, 0.0f, 1.0f, 1.0f), 1337, 1338),
				DirectX::VertexPositionColorExtended(DirectX::XMFLOAT3(1.0f, 1.0f, -1.0f), DirectX::XMFLOAT4(0.0f, 1.0f, 0.0f, 1.0f), 1337, 1338),
				DirectX::VertexPositionColorExtended(DirectX::XMFLOAT3(1.0f, 1.0f, 1.0f), DirectX::XMFLOAT4(0.0f, 1.0f, 1.0f, 1.0f), 1337, 1338),
				DirectX::VertexPositionColorExtended(DirectX::XMFLOAT3(-1.0f, 1.0f, 1.0f), DirectX::XMFLOAT4(1.0f, 0.0f, 0.0f, 1.0f), 1337, 1338),
				DirectX::VertexPositionColorExtended(DirectX::XMFLOAT3(-1.0f, -1.0f, -1.0f), DirectX::XMFLOAT4(1.0f, 0.0f, 1.0f, 1.0f), 1337, 1338),
				DirectX::VertexPositionColorExtended(DirectX::XMFLOAT3(1.0f, -1.0f, -1.0f), DirectX::XMFLOAT4(1.0f, 1.0f, 0.0f, 1.0f), 1337, 1338),
				DirectX::VertexPositionColorExtended(DirectX::XMFLOAT3(1.0f, -1.0f, 1.0f), DirectX::XMFLOAT4(0.0f, 1.0f, 1.0f, 1.0f), 1337, 1338),
				DirectX::VertexPositionColorExtended(DirectX::XMFLOAT3(-1.0f, -1.0f, 1.0f), DirectX::XMFLOAT4(1.0f, 0.0f, 0.0f, 1.0f), 1337, 1338)
			};
		...
		// Loading from a file
		concurrency::task<void> LoadAsync(_In_ ID3D11Device2* device, const std::wstring&) override
		{
			DebugPrint(std::string("\t Cube<VertexPositionColorExtended, unsigned short>::LoadAsync() ...\n"));
